...
type Step = 'basic' | 'budgets' | 'roomCounts' | 'roomNames' | 'roomSelections' | 'exterior' | 'cabinetry' | 'categories' | 'scopeOfWork' | 'template';
...
export default function NewProjectPage() {
  ...
  // Step 7: Categories (now removed, using scopeOfWork instead)
