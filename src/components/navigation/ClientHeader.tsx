    ...
    <header className="bg-white border-b border-neutral-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex gap-2 overflow-x-auto border-t border-neutral-100 py-2 md:hidden">
          <Link href="/client" className={`shrink-0 px-3 py-2 rounded-button text-sm font-medium ${isActive('/client') && !pathname.includes('/projects') ? 'bg-brass-50 text-brass-700' : 'text-neutral-600'}`}>Dashboard</Link>
          ...
          <Link href={selectionsHref} onClick={handleSelectionsClick} className={`shrink-0 px-3 py-2 rounded-button text-sm font-medium ${pathname.includes('/selections') ? 'bg-brass-50 text-brass-700' : firstProjectId ? 'text-neutral-600' : 'text-neutral-400'}`}>Selections</Link>
        </nav>
