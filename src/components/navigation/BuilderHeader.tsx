    ...
    <header className="bg-white border-b border-neutral-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex gap-2 overflow-x-auto border-t border-neutral-100 py-2 md:hidden">
          <Link href="/builder" className={`shrink-0 px-3 py-2 rounded-button text-sm font-medium ${isActive('/builder') && !isActive('/builder/options') && !isActive('/builder/org') ? 'bg-brass-50 text-brass-700' : 'text-neutral-600'}`}>Dashboard</Link>
          <Link href="/projects" className={`shrink-0 px-3 py-2 rounded-button text-sm font-medium ${isActive('/projects') ? 'bg-brass-50 text-brass-700' : 'text-neutral-600'}`}>Projects</Link>
          <Link href="/builder/options" className={`shrink-0 px-3 py-2 rounded-button text-sm font-medium ${isActive('/builder/options') ? 'bg-brass-50 text-brass-700' : 'text-neutral-600'}`}>Options</Link>
          <Link href="/builder/org" className={`shrink-0 px-3 py-2 rounded-button text-sm font-medium ${isActive('/builder/org') ? 'bg-brass-50 text-brass-700' : 'text-neutral-600'}`}>Organization</Link>
        </nav>
