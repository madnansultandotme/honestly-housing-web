    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex gap-2">
        ...
        >
          ...
          {downloading ? 'Downloading...' : 'Download Scope of Work'}
        </Button>
        ...
        <button
          ...
          disabled={downloading}
          className="px-3 py-2 border-2 border-brass-600 text-brass-700 hover:bg-brass-50 rounded-button transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          title="Choose format"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Format Menu */}
      {showFormatMenu && (
        <div className="absolute top-full mt-2 right-0 bg-white border border-neutral-300 rounded-button shadow-lg z-10 min-w-[200px]">
          <div className="p-2">
            ...
            >
              <svg className="w-4 h-4 text-brass-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-neutral-500">Formatted text for documentation</div>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-neutral-500">Styled web page (printable)</div>
              </div>
            </button>
          </div>
        </div>
      ...
      {/* Error Message */}
      {error && (
        <div className="absolute top-full mt-2 left-0 right-0 p-3 bg-red-50 border border-red-200 rounded-button text-red-700 text-sm">
          {error}
        </div>
      )}
