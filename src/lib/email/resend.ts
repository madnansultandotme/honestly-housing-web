      ...
      html: `
        ...
        <html>
          <head>
            <meta charset="utf-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Welcome to Honestly Housing</title>
          </head>
          <body style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #374151; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #B8860B 0%, #8B6914 100%); padding: 40px 20px; text-align: center; border-radius: 12px 12px 0 0;">
              <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 700;">Honestly Housing</h1>
            ...
            <div style="background: white; padding: 40px; border: 1px solid #E5E7EB; border-top: none; border-radius: 0 0 12px 12px;">
              <h2 style="color: #1F2937; margin-top: 0; font-size: 24px;">Welcome, ${displayName}!</h2>
              
              <p style="font-size: 16px; color: #4B5563; margin: 20px 0;">
                <strong>${builderName}</strong> has created an account for you to collaborate on:
              </p>
              ...
              <div style="background: #F9FAFB; border: 2px solid #B8860B; padding: 20px; margin: 30px 0; border-radius: 8px;">
                <div style="margin-bottom: 15px;">
                  <div style="font-size: 12px; color: #6B7280; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">Email</div>
                  <div style="font-size: 16px; font-weight: 600; color: #1F2937; font-family: 'Courier New', monospace;">${email}</div>
                </div>
                <div>
                  <div style="font-size: 12px; color: #6B7280; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">Password</div>
                  <div style="font-size: 16px; font-weight: 600; color: #1F2937; font-family: 'Courier New', monospace;">${password}</div>
                </div>
              </div>
              ...
              <div style="text-align: center; margin: 40px 0;">
                <a href="${loginUrl}" style="display: inline-block; background: #B8860B; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
              ...
              <p style="font-size: 12px; color: #9CA3AF; margin: 0;">
                If you didn't expect this email or have any questions, please contact your builder directly.
              </p>
            </div>
